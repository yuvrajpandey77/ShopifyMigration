#!/usr/bin/env python3
"""
Migrate batches 11-15 from pre-created batch source files.
"""
...
def main():
    ...
    batches_to_migrate = [11, 12, 13, 14, 15]
    total_batches = len(batches_to_migrate)
    
    print(Fore.CYAN + "="*80)
    print(Fore.CYAN + f"MIGRATING BATCHES 11-15 ({total_batches} batches)")
    print(Fore.CYAN + "="*80)
    print()
    ...
    for batch_num in batches_to_migrate:
        ...
        output_path = output_dir / f"shopify_products_batch_{batch_num}_of_15.csv"
